...
public class SimpleMapperCreator {
	...
	private String modelPath = "com.tm.wholesale.model.";
	private String namespace = "com.tm.wholesale.mapper.";
	private String jMapperPackage = "src/main/java/com/tm/wholesale/mapper/";
	...
	public String jHeader(){
		StringBuffer buff = new StringBuffer();
		buff.append("package com.tm.wholesale.mapper;\n\n\n");
		buff.append("import java.util.List;\n\n");
		buff.append("import com.tm.wholesale.model."+this.getModel()+";\n");
		buff.append("import com.tm.wholesale.model.Page;\n\n");
