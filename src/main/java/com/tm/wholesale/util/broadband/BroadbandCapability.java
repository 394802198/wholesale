package com.tm.wholesale.util.broadband;
...
public class BroadbandCapability {
	...
	public static String getCapabilityResultByAddress(String address) throws Exception {
		...
		String geoResult = getHttpResult("http://maps.googleapis.com/maps/api/geocode/xml?address=" + address.replaceAll(" ", "%20") + "&sensor=true");
		String lat = "";
		String lng = "";
