...
public class CustomerInvoice implements Serializable {
	...
	private String customer_invoice_pdf_path;
	private Integer previous_customer_invoice_id;
	...
	public String getCustomer_invoice_pdf_path() {
		return customer_invoice_pdf_path;
	}

	public void setCustomer_invoice_pdf_path(String customer_invoice_pdf_path) {
		this.customer_invoice_pdf_path = customer_invoice_pdf_path;
	}

	public Integer getPrevious_customer_invoice_id() {
		return previous_customer_invoice_id;
	}

	public void setPrevious_customer_invoice_id(Integer previous_customer_invoice_id) {
		this.previous_customer_invoice_id = previous_customer_invoice_id;
	}
