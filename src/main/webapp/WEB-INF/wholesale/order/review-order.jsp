...
<div class="container-fluid">
	...
	<ul class="nav nav-pills nav-wizard" style="">
		...
		<li class="active"><div class="nav-wedge"></div><a href="javascript:void(0);"><span class="glyphicon glyphicon-eye-open"></span> Review Order</a></li>
	</ul>
	<hr>
	
	<div id="review-order-info"></div>
	
</div>

<script type="text/html" id="review_order_info_tmpl" data-ctx="${ctx }">
<jsp:include page="review-order-info.html" />
</script>


<jsp:include page="../footer.jsp" />
<jsp:include page="../script.jsp" />
<script type="text/javascript" src="${ctx}/public/wholesale/order/review-order.js?ver=201493811"></script>
